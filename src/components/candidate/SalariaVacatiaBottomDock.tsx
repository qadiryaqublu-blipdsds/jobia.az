...
export const SalariaVacatiaBottomDock: React.FC<SalariaVacatiaBottomDockProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="relative rounded-2xl p-[1.5px] bg-gradient-to-r from-blue-500/40 via-indigo-400/30 to-amber-400/40 shadow-[0_16px_45px_rgba(0,0,0,0.6)] backdrop-blur-2xl">
        
        {/* Deep Slate Glass Interior */}
        <div className="bg-slate-950/95 rounded-2xl p-2 sm:p-2.5 text-white">
            ...
            <div className="flex items-center justify-between gap-2.5">
              ...
              <div className="flex items-center gap-2 sm:gap-3 flex-1 justify-end">
                ...
                <button
                  ...
                  type="button"
                  onClick={() => onOpenSalaria('salaria')}
                  className={`group relative flex-1 flex items-center justify-between gap-3 px-3.5 sm:px-4 py-2.5 rounded-xl transition-all duration-200 cursor-pointer overflow-hidden active:scale-[0.98] ${
                ...
                >
                  <div className="flex items-center gap-2.5">
                    <div className="w-7 h-7 rounded-lg bg-blue-500/25 border border-blue-400/40 flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform shadow-xs">
                      <Calculator className="w-4 h-4 text-blue-300" />
                    </div>
                    <div className="text-left">
                      <div className="flex items-center gap-1.5">
                        <span className="text-xs sm:text-sm font-black tracking-wide text-white">Salaria</span>
                        <span className="text-[9px] bg-blue-400/20 text-blue-200 border border-blue-400/30 px-1.5 py-0.2 rounded font-black uppercase">
                          Maaş
                        </span>
                      </div>
                      <div className="text-[10px] text-blue-200/80 font-semibold -mt-0.5">
                        Net ⇄ Gross
                      </div>
                    </div>
                  </div>

                  <div className="w-5 h-5 rounded-md bg-white/10 flex items-center justify-center opacity-70 group-hover:opacity-100 group-hover:bg-white/20 transition-all shrink-0">
                ...
                <button
                  ...
                  type="button"
                  onClick={() => onOpenSalaria('vacatia')}
                  className="group relative flex-1 flex items-center justify-between gap-3 px-3.5 sm:px-4 py-2.5 rounded-xl bg-gradient-to-r from-amber-950/90 via-amber-900/80 to-yellow-950/90 hover:from-amber-900 hover:to-orange-900 text-white border border-amber-400/40 hover:border-amber-300/80 shadow-md shadow-amber-950/40 transition-all duration-200 cursor-pointer overflow-hidden active:scale-[0.98]"
                >
                  <div className="flex items-center gap-2.5">
                    <div className="w-7 h-7 rounded-lg bg-amber-500/25 border border-amber-400/40 flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform shadow-xs">
                      <Palmtree className="w-4 h-4 text-amber-300" />
                    </div>
                    <div className="text-left">
                      <div className="flex items-center gap-1.5">
                        <span className="text-xs sm:text-sm font-black tracking-wide text-amber-200">Vacatia</span>
                        <span className="text-[9px] bg-amber-400/25 text-amber-200 border border-amber-400/40 px-1.5 py-0.2 rounded font-black uppercase">
                          Tezliklə
                        </span>
                      </div>
